          ...
          {filteredProducts.map((product) => {
            ...
            return (
              <article key={product.id} className="product-card">
                ...
                >
                  {isFavorite ? <i className="fa-solid fa-heart"></i> : <i className="fa-solid fa-heart-circle-plus"></i>}
                </button>
                ...
                <div className="card-body">
                  ...
                  <h3>{product.name.length > 15 ? `${product.name.slice(0, 12)}...` : product.name}
                  <span style={{ color: 'green' }}> | </span> {product.unit}</h3>
